...
export default function StoreSummary({ store }: Props) {
            ...
            <table className="min-w-full text-sm">
              <tbody>
                ...
                <tr className="border-b border-opacity-20 ">
                  ...
                  <td className="p-3">
                    <p>{formatCurrency(store.defaultShippingFeePerItem)}</p>
                  </td>
                </tr>
                <tr className="border-b border-opacity-20 s">
                  ...
                  <td className="p-3">
                    <p>{formatCurrency(store.defaultShippingFeePerAdditionalItem)}</p>
                  </td>
                </tr>
                <tr className="border-b border-opacity-20 ">
                  <td className="p-3">
                  ...
                  <td className="p-3">
                    <p>{formatCurrency(store.defaultShippingFeePerKg)}</p>
                  </td>
                </tr>
                <tr className="border-b border-opacity-20 ">
                  <td className="p-3">
                  ...
                  <td className="p-3">
                    <p>{formatCurrency(store.defaultShippingFeeFixed)}</p>
                  </td>
                </tr>
                <tr className="border-b border-opacity-20 ">
                  <td className="p-3">
