...
interface Props {
  ...
  setFilter: Dispatch<SetStateAction<UserReviewsQueryFilter>>;
  timePeriod: UserReviewsTimePeriodFilter;
  setTimePeriod: Dispatch<SetStateAction<UserReviewsTimePeriodFilter>>;
  searchTerm: string;
  setSearchTerm: Dispatch<SetStateAction<string>>;
}

export default function ReviewsContainerHeader({
  filter,
  setFilter,
  timePeriod,
  setTimePeriod,
        ...
        <div className="flex items-center">
          ...
          <div className="relative mb-4 w-fit">
            <select
              ...
              value={timePeriod}
              onChange={(e) =>
                setTimePeriod(e.target.value as UserReviewsTimePeriodFilter)
              }
            >
...
const filters: { title: string; filter: UserReviewsQueryFilter }[] = [
  {
    title: "View all",
    filter: "all",
  },
...
const date_filters: { title: string; value: UserReviewsTimePeriodFilter }[] = [
  {
    title: "All time",
    value: "all",
  },
