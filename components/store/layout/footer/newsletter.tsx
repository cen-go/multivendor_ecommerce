  ...
  return (
    <div className="bg-gradient-to-r from-slate-500 to-slate-800 p-5">
      <div className="max-w-[1430px] mx-auto">
        <div className="flex flex-col xl:flex-row gap-y-4 items-center text-white">
          {/* Left */}
          <div className="flex items-center xl:w-[58%]">
            <h5 className="flex items-center gap-x-2">
              ...
              <span className="ml-10">
                ...and receive &nbsp;
                <b>$10 coupon for first purchase.</b>
              </span>
            </h5>
          </div>
          {/* Right */}
          <div className="flex w-full max-w-lg xl:flex-1">
            <input
              type="text"
              placeholder="Enter your email address"
              className="w-full h-10 pl-6 bg-white text-main-primary outline-none rounded-l-full"
            />
